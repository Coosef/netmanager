...
export const GROUP_DEFINITIONS: readonly GroupDef[] = [
  ...
  },
  {
    ...
    tabs: [
      ...
      { key: 'analytics',         route: '/intelligence',      i18nKey: 'nav.tab.monitoring.analytics' },
  ...
  },
  {
    ...
    tabs: [
      ...
      { key: 'services',    route: '/services',         i18nKey: 'nav.tab.alerts.services' },
    ],
  },
  {
    key: 'config',
    ...
    tabs: [
      { key: 'drift',     route: '/config-drift',     i18nKey: 'nav.tab.config.drift' },
  ...
  },
  {
    ...
    tabs: [
      { key: 'sla',     route: '/sla',           i18nKey: 'nav.tab.reports.sla' },
      { key: 'poe',     route: '/poe',           i18nKey: 'nav.tab.reports.poe' },
